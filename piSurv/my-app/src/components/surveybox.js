...
function SurveyBox(props) {
  return (
    <div className='flex flex-row shrink-0 w-[300px] bg-fuchsia-800 rounded-2xl h-[250px] pt-3 md:w-[400px]  '>
        ...
        <div className='item-end ml-3'>
            ...
            <h4 className='text-[14px] md:text-[16px] text-white mt-4 uppercase font-thin'>{props.company}</h4>
